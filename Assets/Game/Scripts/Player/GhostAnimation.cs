...
namespace Game.Scripts.Player
{
    public class GhostAnimation : MonoBehaviour
    {
        ...
        // Kai's remark: I need access to the maxDistance in ElasticForce
        ...
        private void Update()
        {
            ...
            Vector3 playerVec = cat.position - dog.position;
            ...
            ghostBodyJoints[0].position = dog.position - offsetPos;
