	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord49 = IN.ase_texcoord8.xy * appendResult30 + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Texture0, texCoord49 );
				

				float3 BaseColor = ( ( _Color_A + ( _Color_B * tex2D( _Texture0, texCoord48 ).b ) ) * tex2DNode47.r ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( tex2DNode47.g * _Emis ).rgb;
				float3 Specular = 0.5;
				float Metallic = ( tex2DNode47.r * _Metallic );
				float Smoothness = ( tex2DNode47.a * _Smoothness );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult30 = (float2(_Tile , ( _Tile * _Tile_multiply )));
				float2 texCoord49 = IN.ase_texcoord4.xy * appendResult30 + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Texture0, texCoord49 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult30 = (float2(_Tile , ( _Tile * _Tile_multiply )));
				float2 texCoord49 = IN.ase_texcoord2.xy * appendResult30 + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Texture0, texCoord49 );
...
Node;AmplifyShaderEditor.SamplerNode;46;-1120,-368;Inherit;True;Property;_TextureSample0;Texture Sample 0;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;47;-1120,128;Inherit;True;Property;_TextureSample1;Texture Sample 0;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-1872,-688;Inherit;False;Property;_Tile_Pattern;Tile_Pattern;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;48;-1648,-592;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;30;-1888,144;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-2128,192;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-2368,80;Inherit;False;Property;_Tile;Tile;6;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-2368,304;Inherit;False;Property;_Tile_multiply;Tile_multiply;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;49;-1632,-64;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;21;0;47;4
WireConnection;21;1;20;0
WireConnection;17;0;47;2
WireConnection;17;1;16;0
WireConnection;42;0;10;0
WireConnection;42;9;44;0
WireConnection;42;3;40;0
WireConnection;34;0;32;0
WireConnection;34;1;46;3
WireConnection;18;0;47;1
...
ASEEND*/
//CHKSM=2B3F0F29E7A06A12F9C7183BA263207C490CD4F0