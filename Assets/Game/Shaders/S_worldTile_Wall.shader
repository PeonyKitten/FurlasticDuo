...
Shader "FD/S_worldTile_Wall"
{
	Properties
	{
		...
		_Tile_multiply("Tile_multiply", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_cast_0 = (_Tile_Pattern).xx;
				float3 temp_output_44_0 = ( WorldPosition + _offset );
				float4 triplanar42 = TriplanarSampling42( _Texture0, temp_output_44_0, WorldNormal, 1.0, temp_cast_0, 1.0, 0 );
				float2 appendResult30 = (float2(_Tile , ( _Tile * _Tile_multiply )));
				float4 triplanar27 = TriplanarSampling27( _Texture0, temp_output_44_0, WorldNormal, _Falloff, appendResult30, 1.0, 0 );
				

				float3 BaseColor = ( ( _Color_A + ( _Color_B * triplanar42.z ) ) * triplanar27.x ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( triplanar27.g * _Emis ).rgb;
				float3 Specular = 0.5;
				float Metallic = ( triplanar27.r * _Metallic );
				float Smoothness = ( triplanar27.a * _Smoothness );
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_output_44_0 = ( WorldPosition + _offset );
				float4 triplanar42 = TriplanarSampling42( _Texture0, temp_output_44_0, ase_worldNormal, 1.0, temp_cast_0, 1.0, 0 );
				float2 appendResult30 = (float2(_Tile , ( _Tile * _Tile_multiply )));
				float4 triplanar27 = TriplanarSampling27( _Texture0, temp_output_44_0, ase_worldNormal, _Falloff, appendResult30, 1.0, 0 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.ColorNode;16;-784,144;Inherit;False;Property;_Emis;Emis;3;1;[HDR];Create;True;0;0;0;False;0;False;0.06150281,1,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;21;-368,304;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-800,480;Inherit;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;30;-1696,160;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-2176,320;Inherit;False;Property;_Tile_multiply;Tile_multiply;7;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;31;-1936,208;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-800,352;Inherit;False;Property;_Metallic;Metallic;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;23;-2176,96;Inherit;False;Property;_Tile;Tile;6;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;17;-368,32;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-1696,288;Inherit;False;Property;_Falloff;Falloff;8;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;42;-1152,-608;Inherit;True;Spherical;World;False;Top Texture 1;_TopTexture1;white;-1;None;Mid Texture 1;_MidTexture1;white;-1;None;Bot Texture 1;_BotTexture1;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;40;-1616,-640;Inherit;False;Property;_Tile_Pattern;Tile_Pattern;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;32;-1008,-800;Inherit;False;Property;_Color_B;Color_B;2;0;Create;True;0;0;0;False;0;False;0.5372549,0.6509804,0.7176471,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;33;-1008,-992;Inherit;False;Property;_Color_A;Color_A;1;0;Create;True;0;0;0;False;0;False;0.5372549,0.6509804,0.7176471,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-672,-656;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.TexturePropertyNode;10;-1648,-448;Inherit;True;Property;_Texture0;Texture 0;0;0;Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.WorldPosInputsNode;12;-2256,-448;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-371.8593,181.0423;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TriplanarNode;27;-1152,-112;Inherit;True;Spherical;World;False;Top Texture 0;_TopTexture0;white;-1;None;Mid Texture 0;_MidTexture0;white;-1;None;Bot Texture 0;_BotTexture0;white;-1;None;Triplanar Sampler;Tangent;10;0;SAMPLER2D;;False;5;FLOAT;1;False;1;SAMPLER2D;;False;6;FLOAT;0;False;2;SAMPLER2D;;False;7;FLOAT;0;False;9;FLOAT3;0,0,0;False;8;FLOAT;1;False;3;FLOAT2;1,1;False;4;FLOAT;1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;44;-1902.81,-225.891;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;43;-2240,-224;Inherit;False;Property;_offset;offset;10;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;35;-448,-736;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-288,-640;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
WireConnection;21;0;27;4
WireConnection;21;1;20;0
WireConnection;30;0;23;0
WireConnection;30;1;31;0
WireConnection;31;0;23;0
WireConnection;31;1;29;0
WireConnection;17;0;27;2
WireConnection;17;1;16;0
WireConnection;42;0;10;0
WireConnection;42;9;44;0
WireConnection;42;3;40;0
WireConnection;34;0;32;0
WireConnection;34;1;42;3
WireConnection;18;0;27;1
WireConnection;18;1;19;0
WireConnection;27;0;10;0
WireConnection;27;9;44;0
...
ASEEND*/
//CHKSM=F5510D8F9E6208A5EDD15E0136EC5A137D98F520