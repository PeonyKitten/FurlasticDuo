...
Shader "FD/S_Wall_Lab"
{
	Properties
	{
		...
		_T_Wall_Lab_Emis("T_Wall_Lab_Emis", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_T_Wall_Lab_Emis = IN.ase_texcoord8.xy * _T_Wall_Lab_Emis_ST.xy + _T_Wall_Lab_Emis_ST.zw;
				

				float3 BaseColor = ( IN.ase_color.r * _Color ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( ( _Emis + _Emis.a ) * tex2D( _T_Wall_Lab_Emis, uv_T_Wall_Lab_Emis ).r * IN.ase_color.r ).rgb;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_T_Wall_Lab_Emis = IN.ase_texcoord4.xy * _T_Wall_Lab_Emis_ST.xy + _T_Wall_Lab_Emis_ST.zw;
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.RangedFloatNode;13;-880,16;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-880,272;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-960,-416;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;10;-1472,656;Inherit;True;Property;_T_Wall_Lab_Emis;T_Wall_Lab_Emis;4;0;Create;True;0;0;0;False;0;False;-1;def0da08cb606a144bea7322e9f395b6;def0da08cb606a144bea7322e9f395b6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.VertexColorNode;16;-1568,-544;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;15;-1552,-256;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;12;-1504,464;Inherit;False;Property;_Emis;Emis;1;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=028C6D7B3FFD5E99D5BC35F94AA525611F87CC2A